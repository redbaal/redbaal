...
--[[
BY : redbaalTEAM
Channel Files : https://t.me/redbaalFiles
]]
local function keko_redbaal(data)
...
local var = false
local mod = database:sismember('redbaal:'..bot_id..'mods:'..chat_id, user_id)  
local admin = database:sismember('redbaal:'..bot_id..'admins:', user_id)  
local owner = database:sismember('redbaal:'..bot_id..'owners:'..chat_id, user_id)
local creator = database:sismember('redbaal:'..bot_id..'creator:'..chat_id, user_id)  
...
local keko_add_sudo = redis:get('redbaal:'..bot_id..'sudoo'..user_id..'')
...
delete_msg(msg.chat_id_,{[0] = msg.id_})
    ...
    return {
        keko_redbaal = keko_redbaal,
    }
    --[[
    BY : redbaalTEAM
    Channel Files : https://t.me/TVV_VV
    ]]
